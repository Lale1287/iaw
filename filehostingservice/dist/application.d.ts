...
declare const FilehostingserviceApplication_base: (new (...args: any[]) => {
    projectRoot: string;
...
export declare class FilehostingserviceApplication extends FilehostingserviceApplication_base {
