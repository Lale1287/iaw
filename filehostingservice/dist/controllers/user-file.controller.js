...
tslib_1.__decorate([
    (0, rest_1.get)('/users/{id}/files', {
        responses: {
            '200': {
                description: 'Array of User has many File',
                content: {
                    'application/json': {
                        schema: { type: 'array', items: (0, rest_1.getModelSchemaRef)(models_1.File) },
                    },
                },
            },
        },
...
], UserFileController.prototype, "find", null);
tslib_1.__decorate([
    (0, rest_1.post)('/users/{id}/files', {
        responses: {
            '200': {
    ...
    tslib_1.__metadata("design:returntype", Promise)
], UserFileController.prototype, "create", null);
tslib_1.__decorate([
    (0, rest_1.patch)('/users/{id}/files', {
        responses: {
            '200': {
    ...
    tslib_1.__param(2, rest_1.param.query.object('where', (0, rest_1.getWhereSchemaFor)(models_1.File))),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [String, Object, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], UserFileController.prototype, "patch", null);
tslib_1.__decorate([
    (0, rest_1.del)('/users/{id}/files', {
        responses: {
            '200': {
    ...
    tslib_1.__param(0, rest_1.param.path.string('id')),
    tslib_1.__param(1, rest_1.param.query.object('where', (0, rest_1.getWhereSchemaFor)(models_1.File))),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [String, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], UserFileController.prototype, "delete", null);
UserFileController = tslib_1.__decorate([
    tslib_1.__param(0, (0, repository_1.repository)(repositories_1.UserRepository)),
    tslib_1.__metadata("design:paramtypes", [repositories_1.UserRepository])
], UserFileController);
exports.UserFileController = UserFileController;
//# sourceMappingURL=user-file.controller.js.map