...
let UserRepository = class UserRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource, fileRepositoryGetter) {
        super(models_1.User, dataSource);
        this.fileRepositoryGetter = fileRepositoryGetter;
...
UserRepository = tslib_1.__decorate([
    ...
    tslib_1.__param(1, repository_1.repository.getter('FileRepository')),
